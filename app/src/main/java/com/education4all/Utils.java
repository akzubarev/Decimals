...
import com.education4all.mathCoachAlg.tours.QueueItem;
...
//            btn.setTextColor(colormain);
    ...
    public static Utils.twodates isSubsequent(String prevdate, String date) {
        SimpleDateFormat sdf = new SimpleDateFormat("dd.MM.yyyy");
        ...
        try {
            ...
            if (c1.equals(c2))
                return Utils.twodates.equal;
            c1.add(Calendar.DATE, 1);
            if (c1.equals(c2))
                return Utils.twodates.subsequent;
        } catch (ParseException e) {
            e.printStackTrace();
        }

        return Utils.twodates.unrelated;
    }
